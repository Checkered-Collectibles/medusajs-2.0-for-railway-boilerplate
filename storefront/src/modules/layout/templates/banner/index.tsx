 ...
 */
const DROP_DATE_IST = "2026-02-10T21:00:00+05:30"
...
export default function Banner() {
    ...
    return (
        <section className="w-full bg-black text-white py-2 text-center sm:text-md text-sm">
            {isPreDrop && (
                <div className="text-xs sm:text-sm opacity-90 font-medium flex items-center justify-center gap-x-2">
                    <span className="uppercase tracking-wide">
                        📦 Exotics Mainlines 2 Dropping Tonight
                    </span>
            ...
            {isDropLive && (
                <Link
                    href="/collections/exotic-mainlines-2"
                ...
                >
                    <span className="uppercase tracking-wide">
                        🚨 FRESH COLLECTION! <span className="text-yellow-300">Exotics Mainlines 2 IS LIVE</span>
                    </span>
            ...
            {isPostDrop && (
                ...
                >
                    <span className="uppercase tracking-wide text-white">
                        New Arrivals: <span className="font-bold text-white">Exotics Mainlines 2</span> In Stock 📦
                    </span>
                </Link>
            )}
        </section>
